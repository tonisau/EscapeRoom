...
public class MenuOptions {
    static final String m1 = "Add new Room to the Escape Room. ";
    static final String m2 = "Add new Enigma to a Room.";
    static final String m3 = "Add new Clue for an Enigma.";
    static final String m4 = "Add new Decoration object to a Room. ";
